...
assert(styleCss.includes('back_card.jpg'), 'CSS must reference back_card.jpg');
...
console.log('✔ All 3D floating, spinning, laser loading, and HUD CSS rules are present.');
...
assert(/app\.js\?v=(29[5-9]|30[0-9])/.test(indexHtml), 'Cache buster must be bumped to v=295 or higher');
console.log('✔ index.html contains updated table header and exit button styling.');
...
assert(nfcJs.includes('vicard-hud-rank-pill'), 'vicard-hud-rank-pill must be used in nfc.js');

console.log('✔ Both nfc.js and bundled app.js contain all HUD and 3D card loading features!');
